...
public static class RuntimeContext {
    ...
    public static RuntimeContextSlot<T> GetSlot<T>(string slotName) {
        ...
        ArgumentNullException.ThrowIfNullOrEmpty(slotName, nameof(slotName));
        if (GuardNotFound(slotName) is not RuntimeContextSlot<T> slot) {
            throw new InvalidCastException("RuntimeContextSlot<T>");
        }
        return slot;
    }
    ...
    */
    ...
    public static void SetValue(string slotName, object? value) {
        ...
        ArgumentNullException.ThrowIfNull(slotName, nameof(slotName));
        if (GuardNotFound(slotName) is not IRuntimeContextSlotValueAccessor<T> slot) {
            throw new InvalidCastException("RuntimeContextSlot<T>");
        }
        return slot;
