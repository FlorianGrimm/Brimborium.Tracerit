...
public sealed class TracorDataRecordSimpleJsonConverter
...
public sealed class ITracorDataSimpleJsonConverter
...
public static class ITracorDataJsonSimpleConverterUtility {
...
public sealed class TracorDataJsonSimpleConverterFactory : JsonConverterFactory {
    private TracorDataRecordSimpleJsonConverter? _TracorDataRecordJsonConverter;
    private ITracorDataSimpleJsonConverter? _ITracorDataJsonConverter;
    ...
    public override JsonConverter? CreateConverter(Type typeToConvert, JsonSerializerOptions options) {
        if (typeof(ITracorData) == typeToConvert) {
            var result = (this._ITracorDataJsonConverter ??= new ITracorDataSimpleJsonConverter());
            return result;
        }
        if (typeof(TracorDataRecord) == typeToConvert) {
            var result = (this._TracorDataRecordJsonConverter ??= new TracorDataRecordSimpleJsonConverter());
            return result;
        }
