...
public class ConditionTests {
    ...
    public async Task CalleeCondition_ShouldMatchCallerIdentifier() {
        ...
        var matchingCallee = new TracorIdentifier(string.Empty, "Test", "Method", string.Empty);
        var nonMatchingCallee = new TracorIdentifier(string.Empty, "Other", "Method", string.Empty);
        var tracorData = new ValueTracorData<string>("test");
        var context = CreateTestContext();
